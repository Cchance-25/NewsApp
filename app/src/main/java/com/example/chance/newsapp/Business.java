...
public class Business extends AppCompatActivity implements LoaderManager.LoaderCallbacks<ArrayList<News>>{


    private final static String API_KEY = "d6f0833e-7009-4d64-86d1-97d10c3661fd";
    private final static String REQUEST_URL = "https://content.guardianapis.com/business?api-key="+API_KEY;
    private final static String TAG = Business.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = (ListView) findViewById(R.id.business_list_view);
        list = new ArrayList<>();
